...
# page styling
st.set_page_config(page_title="Password Strength Checker By Shoaib Hussain",page_icon="🌘",layout="centered")
# custom css
st.markdown("""
<style>
...
def check_password_strength(password):
    ...
    if score == 4:
         ...
         st.error("❌ ** weekend password** - Follow the suggestions below to strength it.")
